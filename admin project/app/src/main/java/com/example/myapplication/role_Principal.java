...
public class role_Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_role__principal);
                ...
                fauth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(role_Principal.this,"Welcome "+email,Toast.LENGTH_SHORT).show();
                            CheckUserAccess(task.getResult().getUser().getUid());
                        }
                        else {
                            Toast.makeText(role_Principal.this,""+task.getException().getMessage(),Toast.LENGTH_SHORT).show();
