...
public class role_Faculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_role__faculty);
                ...
                fauth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(role_Faculty.this,"Welcome "+email,Toast.LENGTH_SHORT).show();
                            CheckUserAccess(task.getResult().getUser().getUid());
                        }
                        else {
                            Toast.makeText(role_Faculty.this,""+task.getException().getMessage(),Toast.LENGTH_SHORT).show();
